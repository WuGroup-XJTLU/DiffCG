...
def get_target_dict(temp):
    ...
    # BDF
    bdf_bin_centers, bdf_bin_boundaries, sigma_BDF = custom_quantity.bdf_discretization(
    ...
    bdf_struct = custom_quantity.BDFParams(
        reference_bdf, bdf_bin_centers, bdf_bin_boundaries, sigma_BDF, bond_top
    )

    # ADF
    adf_bin_centers, adf_bin_boundaries, sigma_ADF = custom_quantity.adf_discretization(
    ...
    # DDF
    ddf_bin_centers, ddf_bin_boundaries, sigma_DDF = custom_quantity.ddf_discretization(
    ...
    ddf_struct = custom_quantity.DDFParams(
    ...
    rdf_struct = custom_quantity.InterRDFParams(
...
if 'ddf' in target_dict:
    ...
    ddf_dict = {'compute_fn': ddf_fn, 'target': ddf_struct.reference_adf, 'gamma': 1.0}
